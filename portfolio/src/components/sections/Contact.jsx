...
const Contact = () => {
  ...
  const socialIcons = [
    ...
    { icon: Mail, href: socialLinks.email, label: 'Email', color: '#00D4FF' },
  ]
            ...
            <div className="space-y-4 mb-10">
              {contactInfo.map(({ icon: Icon, label, value, href }) => (
                ...
                >
                  ...
                  <div>
                    <p className="text-xs mb-1" style={{ color: '#8892B0' }}>
                      {label}
                    </p>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  <label className="block text-sm mb-2" style={{ color: '#8892B0' }}>
                    Your Name *
                  </label>
                  <input
                    type="text"
              ...
              <motion.button
                ...
                whileHover={
                  status === 'idle'
                    ? { scale: 1.02, boxShadow: '0 0 30px rgba(123,47,190,0.5)' }
                    : {}
                }
